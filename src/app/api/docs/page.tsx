      ...
      <div className="mb-8">
        ...
        <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-4">
          ...
          <ul className="list-disc pl-5 mb-2 font-montserrat">
            <li><strong>apiBrewUuid</strong>: A UUID generated by the API that serves as the unique immutable key for the record in the database.</li>
            <li><strong>brewUuid</strong>: A UUID provided by the companion app that serves as a reference for the app.</li>
          </ul>
          <p className="text-gray-700 font-montserrat">
            When creating a new brew, you can provide a <code className="bg-gray-100 px-1">brewUuid</code> from the companion app. The API will generate a new <code className="bg-gray-100 px-1">apiBrewUuid</code> for the brew and return both UUIDs in the response. Reviews reference brews using the <code className="bg-gray-100 px-1">apiBrewUuid</code> field.
          </p>
        </div>
      </div>
